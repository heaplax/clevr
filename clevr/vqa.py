...
class VQA:
    ...
    def loadRes(self, resFile, quesFile):
        ...
        if not set(annsQuesIds) == set(
            self.getQuesIds()
        ):
            print("Results do not correspond to current VQA set. Either the results do not have predictions for all question ids in annotation file or there is atleast one question id that does not belong to the question ids in the annotation file.")
        for ann in anns:
            quesId = ann["question_id"]
